...
<div class="flex items-center justify-between">
    ...
    <div class="flex items-center">
        <!-- Add Question -->
        <button type="button" @click="addQuestion()" class="flex items-center text-xs py-1 px-3 mr-2 rounded-sm text-white bg-gray-700">
            <svg
...
const emit = defineEmits(["change", "addQuestion", "deleteQuestion"]) // Component custom event 
...
function uppderCaseFirst(str) {
    return str.charAt(0).toUpperCase() + str.slice(1)
}

// Check question have option
